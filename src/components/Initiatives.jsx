...
const initiatives = [
  ...
  },
  {
    title:"StartUP",
    description:
      "платформа для розвитку бізнес ідей, де студенти презентують власні стартапи перед потенційними інвесторами, а також отримують реальні можливості для розвитку та просування проєкту.",
  },
];
