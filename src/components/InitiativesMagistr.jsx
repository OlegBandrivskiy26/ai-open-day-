...
const initiativesData = [
  ...
  {
    title: "Можливість обрати технологію для детального вивчення",
    description: "Гнучкість у виборі стеку технологій для поглибленого освоєння."
  },
  {
    title: "Дуальна та неформальна освіта",
    description: "Поєднання навчання на практиці та нетрадиційного формату."
  },
  {
